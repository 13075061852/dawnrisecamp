/* eslint-disable */
// Generated by Wrangler by running `wrangler types .\src\worker-configuration.d.ts` (hash: 6414a0722ddc536d2d81665fa63a967c)
// Runtime types generated with workerd@1.20260515.1 2026-05-17 
interface __BaseEnv_Env {
	MEDIA_BUCKET: R2Bucket;
	DB: D1Database;
	ALLOWED_ORIGINS: "http://127.0.0.1:5173,http://localhost:5173,https://dawnrisecamp-web.pages.dev,https://*.dawnrisecamp-web.pages.dev";
}
