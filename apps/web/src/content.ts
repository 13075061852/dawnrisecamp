...
export const copy = {
  en: {
    ...
    about: {
      ...
      supplierChannels: [
        { name: "Amazon", imageUrl: "/images/供应商/amazon.png" },
        { name: "Walmart", imageUrl: "/images/供应商/walmart.png" },
        { name: "eBay", imageUrl: "/images/供应商/ebay.png" },
        { name: "AliExpress", imageUrl: "/images/供应商/aliexpress.png" },
        { name: "Alibaba", imageUrl: "/images/供应商/alibaba.png" },
        { name: "Wish", imageUrl: "/images/供应商/wish.png" },
        { name: "TikTok", imageUrl: "/images/供应商/tiktok.png" },
        { name: "Shopify", imageUrl: "/images/供应商/shopify.png" },
        { name: "Temu", imageUrl: "/images/供应商/temu.png" },
        { name: "Lazada", imageUrl: "/images/供应商/lazada.png" },
        { name: "Taobao", imageUrl: "/images/供应商/taobao.png" },
        { name: "Tmall", imageUrl: "/images/供应商/tmall.png" },
        { name: "Pinduoduo", imageUrl: "/images/供应商/pinduoduo.png" },
        { name: "Douyin", imageUrl: "/images/供应商/douyin.png" },
        { name: "Kuaishou", imageUrl: "/images/供应商/kuaishou.png" },
        { name: "JD.com", imageUrl: "/images/供应商/jd.png" },
        { name: "Vipshop", imageUrl: "/images/供应商/vipshop.png" },
        { name: "Shopee", imageUrl: "/images/供应商/shopee.png" },
        { name: "Taogongchang", imageUrl: "/images/供应商/taogongchang.png" },
        { name: "Target", imageUrl: "/images/供应商/target.png" },
      ],
...
export const fallbackProducts: Record<Locale, ProductNode[]> = {
  en: [
    ...
    },
    {
      ...
      name: "Camping Furniture & Accessories",
      children: [
